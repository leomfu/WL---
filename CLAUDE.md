...
- **黑白设计系统**：严格遵守 PLAN.md §5。动效克制，尊重 prefers-reduced-motion。
  **界面（UI）只用黑白灰**，两处例外：工具页图标 hover 亮各自品牌色；开场页进站动效里那一下上色（见 docs/进度.md）。
  **内容图片不受这条约束，一律原色**——摄影作品、视频封面、唱片封面都算内容，
  它们本身就是作品，去色等于改了作品。分界线是：**包着图片的界面仍然只有黑白灰**
  （边框、标签、按钮、放大态的底色），彩色只出现在图片自己那块矩形里。
